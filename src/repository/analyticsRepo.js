...
`;
            ...
            if (peakHourResult?.hour !== undefined && peakHourResult?.hour !== null) {
                const moment = require("moment");
                const startHour = moment().hour(peakHourResult.hour).startOf("hour").format("h A");
                const endHour = moment().hour(peakHourResult.hour + 1).startOf("hour").format("h A");
