...
class trafficRepository {
    async getTrafficAnalysisData(sequelize) {
        try {
            ...
            // Get floor-wise count of total people for today (using your existing query)
        ...
        `;
            ...
            // For each floor, we will create a data structure with a totalPeople array
            ...
            return {
                floorCount: floorCounts || [], // Include floor-wise total people for today
